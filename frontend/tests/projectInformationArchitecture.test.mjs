...
test("compare page selection is searchable and mode controls are progressive", () => {
  ...
  assert.match(compareSource, /is-auto-suggested/);
  assert.match(compareSource, /Автоподбор ·/);
  ...
  assert.match(compareSource, /compare-focus-workspace/);
  assert.match(compareSource, /compare-focus-toolbar/);
  ...
  assert.match(cssSource, /compare-loading-dot/);
  assert.match(cssSource, /compare-page-result\.is-auto-suggested/);
  assert.match(cssSource, /compare-focus-workspace/);
