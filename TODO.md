...
- [ ] Friendly UX/UI refinement wave (`P1`, перед расширением новых фич):
  ...
  - проект: дальше не дробить main tab без визуальной проверки.
  - настройки проекта: следующий UX-шаг после визуальной проверки — оценить, нужны ли короткие summary-счётчики внутри `Участники и права` и keyboard-polish combobox.
  ...
  - участники проекта: следующий этап после визуальной проверки — server-side/keyboard polish для combobox при необходимости (`↑/↓/Enter`, ARIA active descendant).
