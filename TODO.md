...
- [ ] Friendly UX/UI refinement wave (`P1`, перед расширением новых фич):
  ...
  - проект: дальше не дробить main tab без визуальной проверки; следующий UX-кандидат — searchable combobox участников.
  - настройки проекта: следующий UX-шаг — убрать дубли заголовков внутри раскрытых секций и заменить поле добавления участника на searchable combobox по существующим пользователям.
