...
- [ ] Friendly UX/UI refinement wave (`P1`, minimal UI pass перед расширением новых фич):
  ...
  - Этап 5 follow-up — Compare visual polish: после визуальной проверки доработать подсветку auto-picked slots, micro-spinner внутри автоподбора и финальный focus workspace без лишних панелей, если текущий layout всё ещё перегружен.
