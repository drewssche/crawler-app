...
- [ ] Friendly UX/UI refinement wave (`P1`, перед расширением новых фич):
  ...
  - проект: продолжить упрощение главной вкладки — сделать структуру сайта компактнее через summary + filters, добавить persisted collapsed-state там, где это не мешает контролю пользователя.
