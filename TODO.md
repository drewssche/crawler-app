...
- [ ] Friendly UX/UI refinement wave (`P1`, перед расширением новых фич):
  ...
  - проект: добавить persisted collapsed-state для раскрываемых блоков там, где это не мешает контролю пользователя; дальше не дробить main tab без визуальной проверки.
