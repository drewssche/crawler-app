...
- [ ] Friendly UX/UI refinement wave (`P1`, перед расширением новых фич):
  ...
  - настройки проекта: следующий UX-шаг — убрать дубли заголовков внутри раскрытых секций и оценить, нужны ли короткие summary-счётчики внутри `Участники и права`.
