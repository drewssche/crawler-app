...
- [ ] Friendly UX/UI refinement wave (`P1`, перед расширением новых фич):
  ...
  - проект: дальше не дробить main tab без визуальной проверки; следующий UX-кандидат — настройки проекта accordion-секциями или searchable combobox участников.
