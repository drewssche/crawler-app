...
- [ ] Friendly UX/UI refinement wave (`P1`, перед расширением новых фич):
  ...
  - проект: продолжить упрощение главной вкладки — довести секции ежедневной работы до collapsible/card layout, убрать лишние технические формулировки из первого экрана, добавить persisted collapsed-state там, где это не мешает контролю пользователя.
